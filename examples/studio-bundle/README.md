...
The [ML graph architecture guide](../../docs/ML_GRAPH_ARCHITECTURES.md) describes the shape-checked Yumon NPC, Yumon Pet, and Mini-Pic graph presets in the ML Graph Trainer addon, and the current MLP-only training boundary.
