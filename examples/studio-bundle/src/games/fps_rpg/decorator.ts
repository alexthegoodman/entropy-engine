...
import { ProceduralHumanoid } from "../level_editor_3d/humanoid_v2";
import { FPSUI, type DialogueOption, type DialogueState } from "./fps_ui";
import { addon } from "./index";
import { Faction, factions, quests } from "./quests";
import { worldManager } from "./world";
import { gameState } from "./state";
import { FloorPlan, HOUSE_SHADER, HouseGeometry, MeshBuilder, Rect, vec2, vec3, type HouseParams } from "../level_editor_3d/procedural_houses_addon";
