...
pub struct AddonRenderTarget {
    ...
    pub g_buffer_position_view: Arc<wgpu::TextureView>,
    pub g_buffer_normal_view: Arc<wgpu::TextureView>,
    pub g_buffer_albedo_view: Arc<wgpu::TextureView>,
    pub g_buffer_pbr_material_view: Arc<wgpu::TextureView>,
